...
import org.visallo.ingestontologymapping.util.mapping.GeoPointPropertyMapping;
...
import static org.visallo.ingestontologymapping.mapping.MappingTestHelpers.*;
...
public class GeoPointPropertyMappingTest {
    ...
    private final Map<String, String> DECIMAL_ROW = createIndexedMap("39.062139, -77.465943", "39.062139", "-77.465943");
    private final Map<String, String> DM_ROW = createIndexedMap(new String[] { "39° 3.72834', -77° 27.95657'", "39° 3.72834'", "-77° 27.95657'"});
    private final Map<String, String> DMS_ROW = createIndexedMap(new String[] { "39° 3' 43.7004\", -77° 27' 57.3942\"", "39° 3' 43.7004\"", "-77° 27' 57.3942\""});
    ...
    public void testTwoColumnsWithOneBlank() throws Exception {
        ...
        Map<String, String> input = new HashMap<>(DECIMAL_ROW);
        input.put(2 + "", "");
