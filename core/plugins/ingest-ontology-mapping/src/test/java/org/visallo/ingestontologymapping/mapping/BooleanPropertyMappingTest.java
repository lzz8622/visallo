...
import org.visallo.ingestontologymapping.util.mapping.BooleanPropertyMapping;
...
public class BooleanPropertyMappingTest {
    ...
    public void testUnknownValue() throws Exception {
        ...
        Map<String, String> row = createIndexedMap("maybe");
    ...
    public void testBlankValueWithNoDefault() throws Exception {
        ...
        Map<String, String> row = createIndexedMap("    ");
